package university.management.system.GUI;
...
public class Project extends JFrame implements ActionListener{
    public Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/ab.jpg"));
        Image i3 = ic.getImage().getScaledInstance(1900, 1150,Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("New Student Admission")){
            ...
            try{
                Runtime.getRuntime().exec("C:\\Users\\Shreesh\\AppData\\Local\\Programs\\Opera GX\\launcher.exe");
            }catch(Exception e){ }
